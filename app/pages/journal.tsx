...
import { Calendar, Pen, TagIcon } from "lucide-react-native";
    ...
    <View className="flex-1 bg-stone-200 p-5">
      ...
      <View className="flex-row gap-2 mt-2">
        ...
        >
          ...
          <Text className="text-teal-600">Journal</Text>
        </Button>
        ...
        <Button
          ...
          style={{ borderColor: "#0d9488" }}
        >
          <TagIcon size={18} color="#0d9488" strokeWidth={2} />
          <Text className="text-teal-600">Tags</Text>
        </Button>
      </View>
